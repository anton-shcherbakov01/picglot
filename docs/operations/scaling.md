...
|---|---|---|
| `lingoimage_queue_depth` (Prometheus) | Sustained > 200 for 10 min | Add `worker-cpu` replicas |
...
| `lingoimage_provider_circuit_open` | Any provider open for > 5 min | See [provider-outage.md](provider-outage.md) |
