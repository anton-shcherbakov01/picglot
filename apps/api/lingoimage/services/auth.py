...
from lingoimage.core.ratelimit import login_attempts
...
from lingoimage.domain.enums import UserStatus
from lingoimage.services import credits
...
def claim_guest_projects(session: DbSession, guest: GuestSession, user: User) -> int:
    ...
    from lingoimage.db.models import Project
...
def export_user_data(session: DbSession, user: User) -> dict[str, Any]:
    ...
    from lingoimage.db.models import ApiKey, Project
