...
from lingoimage.core.metrics import payment_webhook_failures_total
...
class YooKassaProvider:
    ...
    def create_checkout(
        ...
        **_kwargs: Any,
        ...
        body = {
            ...
            "description": description[:128] or "LingoImage AI",
            "metadata": metadata,
    ...
    def verify_and_parse(self, body: bytes, headers: dict[str, str]) -> NormalizedEvent:
        ...
        if secret:
            provided = headers.get("x-lingoimage-webhook-secret", "")
