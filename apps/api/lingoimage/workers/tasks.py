...
from lingoimage.domain.enums import ExportFormat, JobStatus, WebhookEvent
...
# Notifications
# --------------------------------------------------------------------------- #
@_task("lingoimage.deliver_webhook")
...
# --------------------------------------------------------------------------- #
@_task("lingoimage.lifecycle_maintenance")
...
@_task("lingoimage.stuck_jobs_maintenance")
...
@_task("lingoimage.webhook_retry_maintenance")
...
@_task("lingoimage.monthly_credits_maintenance")
def monthly_credits_maintenance() -> dict[str, Any]:
    from sqlalchemy import select

    from lingoimage.db.models import User
...
@_task("lingoimage.provider_health_maintenance")
def provider_health_maintenance() -> dict[str, Any]:
    from sqlalchemy import select

    from lingoimage.db.models import ProviderConfiguration
