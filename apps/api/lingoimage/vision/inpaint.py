...
from lingoimage.vision.preprocess import dominant_color, surround_complexity, to_cv, to_pil
...
def _advanced_inpaint(image: Image.Image, mask: Image.Image) -> Image.Image | None:
    ...
    if not settings.advanced_inpaint_enabled:
        return None
    try:
        from lingoimage.vision.advanced_inpaint import run_model  # type: ignore[import-not-found]
    except ImportError:
