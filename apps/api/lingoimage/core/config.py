...
class Settings(BaseSettings):
    ...
    # ---------------------------------------------------------------- brand
    brand_name: str = "LingoImage AI"
    brand_legal_entity: str = "LingoImage AI"
    brand_support_email: str = "support@lingoimage.ai"
    brand_domain: str = "lingoimage.ai"
    ...
    # ------------------------------------------------------------- database
    database_url: str = "postgresql+psycopg://lingo:lingo@localhost:5432/lingoimage"
    ...
    s3_access_key_id: str = "lingoimage"
    s3_secret_access_key: str = "lingoimage-dev-secret"
    s3_bucket: str = "lingoimage"
    ...
    session_cookie_name: str = "lingo_session"
    session_cookie_secure: bool = False
    session_cookie_domain: str = ""
    guest_cookie_name: str = "lingo_guest"
    csrf_cookie_name: str = "lingo_csrf"
    ...
    email_from: str = "noreply@lingoimage.ai"
    email_from_name: str = "LingoImage AI"
    ...
    otel_service_name: str = "lingoimage-api"
    ...
    seed_admin_email: str = "admin@lingoimage.example"
    seed_admin_password: str = "Sup3r!Seed-2026"
    seed_demo_email: str = "demo@lingoimage.example"
    ...
    def _production_problems(self) -> list[str]:
        ...
        if self.s3_secret_access_key in {"lingoimage-dev-secret", ""}:
...
def _format_validation_error(exc: ValidationError) -> str:
    lines = ["LingoImage AI cannot start: the configuration is invalid.", ""]
