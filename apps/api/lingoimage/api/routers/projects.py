...
from lingoimage.core.ratelimit import uploads as upload_limit
from lingoimage.core.security import hash_ip
from lingoimage.db.models import Asset, DocumentPage, Export, Job, Project, TableCell, TextRegion
from lingoimage.domain import credits as credit_rules
from lingoimage.domain import tools as tool_catalog
...
from lingoimage.services import lifecycle, storage
from lingoimage.services import projects as project_service
from lingoimage.services import share as share_service
from lingoimage.services import translation as translation_service
...
def merge_regions(
    ...
    primary = regions[0]
    from lingoimage.vision.types import BoundingBox
...
def reocr_region(
    ...
    from lingoimage.vision import normalize as normalize_tools
    from lingoimage.vision.types import BoundingBox
...
def update_table_cells(
    ...
    from lingoimage.vision.tables import classify_value
...
def _render_pages(
    ...
    from lingoimage.vision import inpaint
    from lingoimage.vision import render as render_tools
...
def revoke_share(
    ...
    from lingoimage.db.models import ShareLink
...
def _set_translation(
    ...
    *,
    ...
    from lingoimage.db.models import RegionTranslation
...
def _page_out(session: Any, page: DocumentPage) -> PageOut:
    from lingoimage.schemas import TableCellOut, TableOut
