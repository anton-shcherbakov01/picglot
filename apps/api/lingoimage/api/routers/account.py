...
from lingoimage.core.security import generate_api_key
...
from lingoimage.services import webhooks as webhook_service
...
def replay_delivery(
    ...
    from lingoimage.db.models import WebhookDelivery
...
def create_glossary(
    ...
    from lingoimage.domain import languages, plans
...
def delete_account(
    ...
    session.commit()
    from lingoimage.api.deps import clear_session_cookie
