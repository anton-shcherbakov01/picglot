...
from lingoimage.api.routers import account, admin, auth, billing, jobs, projects, public, system
from lingoimage.core.config import settings
from lingoimage.core.errors import AppError, ErrorCode
from lingoimage.core.ids import request_id as new_request_id
from lingoimage.core.logging import bind_request, clear_context, configure_logging, get_logger
from lingoimage.core.metrics import http_request_duration, http_requests_total
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    try:
        from lingoimage.workers.dispatch import shutdown
        ...
        pass
    from lingoimage.db.session import dispose_engine
