...
from picglot.core.metrics import webhook_delivery_failures_total
from picglot.core.security import decrypt_secret, sign_webhook
from picglot.db.models import WebhookDelivery, WebhookEndpoint
from picglot.domain.enums import DeliveryStatus, WebhookEvent
...
def _schedule(delivery_id: str) -> None:
    ...
    celery_app.send_task("picglot.deliver_webhook", args=[delivery_id], queue="notifications")
    ...
    try:
        response = httpx.post(
            ...
            headers={
                ...
                "X-PicGlot-Signature": signature,
                "X-PicGlot-Event": delivery.event,
                "X-PicGlot-Event-Id": delivery.event_id,
                "X-PicGlot-Delivery": delivery.id,
                "X-PicGlot-Attempt": str(delivery.attempt),
            },
...
def create_endpoint(
    ...
    *,
    ...
    from picglot.core.ids import token
    from picglot.core.security import encrypt_secret
