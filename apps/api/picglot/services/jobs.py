...
from picglot.core.metrics import job_duration, jobs_total, queue_depth
from picglot.core.redis import get_redis
from picglot.db.models import Job, JobEvent, Project, User
...
def dispatch(job: Job) -> None:
    ...
    from picglot.workers import dispatch as worker_dispatch
